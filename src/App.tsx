import { FC, useMemo, useEffect } from "react";
            ...
            useEffect(() => {
              ...
              const userData = useMemo(() => ({
                name: "Prashun Lamichhane",
                email: "prashunlamichhane764@gmail.com",
                phone: "+977-9863818095",
                company: "company",
                location: "Birtamode-04 Jhapa Nepal",
                about: "Greetings, I'm Prashun Lamichhane, an enthusiastic student enrolled at IOST, Tribhuvan University. I'm fueled by my passion for data science and my insatiable curiosity about the dimensions of time, space, and multiverses. ",
                skills: ["HTML","CSS","C++","NodeJs","Machine Learning","C","JavaScript","TypeScript"],
                projects: [], 
                work: [],
                role: "USER",
                profession: "Software Engineer",
                services: ["WEB_DEVELOPMENT","PROJECT_MANAGEMENT","MACHINE_LEARNING","DATA_SCIENCE"],
                slugs: []
              }),
              []
            );
            ...
            const homeData = useMemo(
                    () => ({
                      headerOne: "I'm Prashun Lamichhane, a Software Engineer from Birtamode-04 Jhapa Nepal",
                      descriptionOne: "Greetings, I'm Prashun Lamichhane, an enthusiastic student enrolled at IOST, Tribhuvan University. I'm fueled by my passion for data science and my insatiable curiosity about the dimensions of time, space, and multiverses. ",
            ...
            const aboutData = useMemo(
                    () => ({
                      headerOne: "Hello, I'm Prashun Lamichhane",
                      ...
                      sections: [
                        {
                          ...
                          details: {
                            ...
                            faq: [{"question":"What is your design process?","answer":"My design process starts with understanding the client's needs, then moving onto research, ideation, prototyping, and finally, implementation.","id":"444"},{"question":"How long does a project usually take?","answer":"The duration of a project varies depending on its complexity and scope, but typically it ranges from a few weeks to a few months.","id":"445"},{"question":"Do you collaborate with other designers?","answer":"Yes, I often collaborate with other designers and believe that teamwork can lead to more innovative and comprehensive solutions.","id":"446"},{"question":"What types of projects do you work on?","answer":"I work on a wide range of projects, from website and app design to branding and graphic design. Each project brings its own unique challenges and opportunities.","id":"447"},{"question":"How can I contact you for a project?","answer":"You can reach out to me via the contact form on this website, or directly through email. I look forward to discussing how we can work together.","id":"448"}],
                            order: 1
                          }
                        },
                      ],
